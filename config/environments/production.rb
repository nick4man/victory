...
Rails.application.configure do
  ...
  config.action_cable.url = ENV.fetch('ACTION_CABLE_URL', "wss://#{ENV.fetch('APP_DOMAIN', 'viktory-realty.ru')}/cable")
  config.action_cable.allowed_request_origins = [
    ENV.fetch('APP_URL', 'https://viktory-realty.ru'),
    /https?:\/\/viktory-realty\.ru/
  ]

  # Force all access to the app over SSL, use Strict-Transport-Security, and use secure cookies.
  # SECURITY: Must be enabled once SSL certificates are configured.
  # Set DISABLE_SSL=true in ENV only for local testing behind a TLS-terminating proxy.
