...
Пути внутри репозитория приведены к относительным: в `main` было **245** строк с
`/home/q` в 47 файлах, осталось **86 в 22 файлах** — то есть переведено 159 строк. Остаток
