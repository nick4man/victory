...
> Канонический экземпляр этого документа — здесь, в репозитории. Копия в `~/.claude/plans/` — глобальный каталог с переиспользуемыми автоименами, где мы уже потеряли два документа; она держится синхронной, но источник правды не там.
