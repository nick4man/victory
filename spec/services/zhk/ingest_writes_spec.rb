...
RSpec.describe Zhk::Ingest do
  ...
  # Мусор ФОРМЫ этой колонки: два значения на форму, чтобы инвариант не
  # удовлетворялся случайной проверкой на один конкретный тип.
  def garbage_for(shape)
    ...
    when :datetime then ['2026-13-45', { 'ключ' => 'значение' }]
