...
# Core Rails — EOL Phase 2: 7.2.3.2 → 8.1 (7.2.x EOL 2026-08-09). Ruby 3.4.10 совместим
# (YJIT доступен, не включён). 8.1.3.1 нативно закрывает CVE-2026-66066 (Active Storage).
