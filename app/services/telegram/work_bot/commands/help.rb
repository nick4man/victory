    ...
    module Commands
      ...
      class Help < Base
        ...
        ENTRIES = [
          ...
          # Phase 15 — 6 команд DM-friendly: group reply ИЛИ <lead_id> первым arg
          ['/route',        :manager,
           'Маршрутизировать лид: group reply + <code>/route apartments</code> ИЛИ DM <code>/route 87 apartments</code>'],
          ['/assign',       :manager,
           'Назначить агента: reply + <code>/assign @user</code> ИЛИ DM <code>/assign 87 @user</code> ' \
          ...
          ['/starttest',    :director,
           'Разбудить песочницу карточек и получить список того, что в ней проверяем']
        ].freeze
